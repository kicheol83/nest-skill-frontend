...
const FaqArticles: NextPage = (props: any) => {
  ...
  const {
    ...
    onCompleted: (data: T) => {
      ...
      const faqNotices = allNotices.filter(
        (n: any) => n.noticeCategory === NoticeCategory.FAQ
      );
      setNotices(faqNotices);
      setFaqTotal(faqNotices.length);
    },
  });
          ...
          <TabContext value={"value"}>
            ...
            <FaqArticlesPanelList
              notices={notices.filter(
                (n) => n.noticeCategory === NoticeCategory.FAQ
              )}
              anchorEl={anchorEl}
